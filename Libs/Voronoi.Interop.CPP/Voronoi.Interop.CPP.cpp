// Voronoi.Interop.CPP.cpp : Définit les fonctions de la bibliothèque statique.
//
...
int fnVoronoiInteropCPP(Point* pts, int points_nb, Line** lines, int* lines_nb, const wchar_t* assembly)
{
